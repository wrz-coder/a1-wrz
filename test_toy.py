...
from src import matmul_with_importance, matmul_with_multi_head
...
def test_task1(case_key, case_config):
    ...
    if case_key == "case1":
        output_ref = torch.tensor(
            [[[[ 0.9882,  1.2122,  1.2686],
            [-0.4750,  0.0144, -1.9522]],

            [[-0.9339,  0.1927, -1.0724],
            [ 0.3789,  0.6593, -1.5971]],

            [[ 1.2396, -0.1764,  1.4309],
            [ 0.6918,  0.8920, -1.4501]],

            [[-0.3715, -0.4576, -0.4771],
            [ 0.6216,  0.3882,  0.6406]],

            [[-0.1983,  0.8432, -0.1518],
            [ 0.4134,  0.2719,  0.3612]]],


            [[[ 0.8240, -0.2555,  0.9381],
            [-1.1644, -1.3621,  1.7858]],

            [[ 0.2324,  0.0611,  0.2771],
            [-1.4217, -1.0713, -0.6024]],

            [[ 0.4355,  0.7822,  0.5825],
            [ 1.1805,  1.1055, -0.5153]],

            [[ 0.7242, -0.6270,  0.7864],
            [-0.5242, -0.9216,  2.2543]],

            [[-0.3756,  0.5627, -0.3854],
            [ 1.6768,  1.7299, -1.4826]]]]
